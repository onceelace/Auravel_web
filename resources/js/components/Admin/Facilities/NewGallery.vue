    ...
    <div class="row justify-content-center mt-5">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form @submit.prevent="createGalery" @keydown="form.onKeydown($event)" enctype="multipart/form-data">
    ...
    export default {
        ...
        methods: {
            createGalery(e){
                ...
                this.form.submit('post', '/api/admin/gallery', {
                ...
                .then(({data}) => {
                    ...
                    Toast.fire({
                        type: 'success',
                        title: 'Gallery has been created'
                    })
                    ...
                    Toast.fire({
                        type: 'error',
                        title: 'Failed to save the Gallery'
                    })
                });
            },
